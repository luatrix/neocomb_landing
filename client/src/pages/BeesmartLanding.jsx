      ...
      <section id="thumbee" className="bg-gradient-to-r from-white to-[#d1f9f6] py-20 px-6 md:px-12 min-h-screen flex items-center">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h3 className="text-4xl font-bold text-[#2DD4BF] mb-4">ThumBee</h3>
            <p className="text-gray-700 text-lg mb-4">
            ...
            <a
  href="/thumbee"
  className="inline-flex items-center gap-2 bg-[#2DD4BF] hover:bg-[#1cc4ac] text-white px-5 py-3 rounded-full text-sm font-semibold transition">
